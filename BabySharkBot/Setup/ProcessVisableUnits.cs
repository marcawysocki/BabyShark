...
namespace BabySharkBot.Setup
{
    public static class ProcessVisableUnits
    {
            ...
            SpawningPoolPlacementService? spawningPoolPlacementService = null)
        {
            ...
            var baseHasBeenPlayed = Settings.WorkerCount == 8 ? Settings.CurrentBaseHasBeenPlayed8 : (Settings.WorkerCount == 12 ? Settings.CurrentBaseHasBeenPlayed12 : Settings.CurrentBaseHasBeenPlayed);
